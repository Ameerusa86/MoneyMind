          ...
          <div className="relative hidden lg:block rounded-xl overflow-hidden border border-gray-800 bg-gray-900">
            ...
            <div className="absolute bottom-6 left-6 right-6 text-gray-200">
              ...
              <p className="mt-2 text-gray-300">
                Start tracking your finances with clarity and control.
              </p>
            </div>
          </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <label className="flex items-center gap-3 text-sm text-gray-300">
                <input
                  ...
                  className="h-4 w-4 rounded border-gray-700 bg-gray-900 text-purple-600 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-purple-500"
                />
                I agree to the
